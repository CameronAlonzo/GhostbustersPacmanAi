...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        prob = 0
        #Find the maximum belief location
        for beliefs in livingGhostPositionDistributions:
            ...
            if newProb > prob:
                goalPos = location
                prob = newProb
        #HEY HEY ITS YA BOY MINIMAX BACK AGAIN
        minimizer = 999999
        bestMove = legal[0]
        for action in legal:
            ## call the function provided
            maximizer = self.distancer.getDistance(Actions.getSuccessor(pacmanPosition,action),goalPos)
